...
export const AutoplayProvider: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
  const [isAutoplay, setIsAutoplay] = useState(true);
  const autoplayIntervalRef = React.useRef<ReturnType<
    typeof setTimeout
  > | null>(null);
  ...
  return (
    <AutoplayContext.Provider
      value={{ isAutoplay, toggleAutoplay, startAutoplay, stopAutoplay }}
    >
      {children}
    </AutoplayContext.Provider>
  );
